...
# Rampe séquentielle bleue du RAPPORT (make_figures.py : pas des figures 3
# et 4), pour que l'app et le rapport portent les mêmes couleurs. Séries
# ordonnées uniquement : MRC/LRC/ECON et 0/1/2 step-climbs.
SER1, SER2, SER3 = "#A9C4EC", "#5487D6", "#173F8A"
...
# pages sans volet de droite (Croisière, Trajectoire : contrôles en barre
# horizontale → le ruban gauche se déroule en grand).
