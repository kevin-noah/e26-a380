...
def print_perf_menu():
    ...
    print("         --ci    : Cost Index pour ECON [kg/min] (défaut 160)")
    ...
    print()
    print("  Exemple :  cruise --mass 450000 --h 10668 --ci 160")
    print()
    print("  help   Afficher cette aide")
    print("  back   Retour au menu principal")
    print("─" * 64)
...
def _build_perf_parser():
    ...
    p.add_argument("--h",    type=float, required=True, metavar="ALTITUDE")
    p.add_argument("--disa", type=float, default=0.0,   metavar="ΔISA")
    p.add_argument("--ci",   type=float, default=mod_perf.CI_DEFAUT, metavar="KG/MIN")
